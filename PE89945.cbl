      ...
      *AUTHOR.       DID.
      *DATE-WRITTEN.
      *     PE80620 Generado el 24/01/2025 por GenSKL V03.3.
      *=================================================================
      *=================================================================
      *= APLICACION: PE                                                =
      *=================================================================
      ...
      *
       77  WLT-MODULO         PIC X(8)   VALUE 'PE80620'.
      ...
      * VARIABLES DE TRABAJO
       ...
       01  W-VARIABLES.
           ...
           05 WSS-PE8062I.
             07 WSS-PE8062I-NUMPERSEMP PIC ZZZZZ9999.
             07 WSS-PE8062I-NUMPERSACC PIC ZZZZZ9999.
             07 WSS-PE8062I-NUMPERSNIV PIC S9(9).
             07 WSS-PE8062I-CODRELPEPE PIC ZZ99.
             07 WSS-PE8062I-TMSTALTA  PIC X(26).
             07 WSS-PE8062I-NIVELACC  PIC S9(3).
             07 WSS-PE8062I-PORPARTEMP PIC  9999999.
             07 WSS-PE8062I-FECALTA   PIC X(10).
             07 WSS-PE8062I-FECBAJA   PIC X(10).
             07 WSS-PE8062I-FECULTACT PIC X(10).
             07 WSS-PE8062I-HORULTACT PIC X(8).
             07 WSS-PE8062I-CODTERMINA PIC X(8).
             07 WSS-PE8062I-CODUSUARIO PIC X(8).

           05 WSSS-PE8062I.
             07 WSSS-PE8062I-NUMPERSEMP PIC ZZZZZ9999.
             07 WSSS-PE8062I-NUMPERSACC PIC ZZZZZ9999.
             07 WSSS-PE8062I-NUMPERSNIV PIC S9(9).
             07 WSSS-PE8062I-CODRELPEPE PIC ZZ99.
             07 WSSS-PE8062I-TMSTALTA  PIC X(26).
             07 WSSS-PE8062I-NIVELACC  PIC S9(3).
             07 WSSS-PE8062I-PORPARTEMP PIC  9999999.
             07 WSSS-PE8062I-FECALTA   PIC X(10).
             07 WSSS-PE8062I-FECBAJA   PIC X(10).
             07 WSSS-PE8062I-FECULTACT PIC X(10).
             07 WSSS-PE8062I-HORULTACT PIC X(8).
             07 WSSS-PE8062I-CODTERMINA PIC X(8).
             07 WSSS-PE8062I-CODUSUARIO PIC X(8).
      ...
      *
       INICIO.
           ...
           ACCEPT DATA-PROCESS   FROM SYSIN
           IF     DATA-PROCESS   IS NOT NUMERIC or
                  DATA-PROCESS   = ZEROS
                  DISPLAY 'OPCION DE PROCESO NO RECIBIDA '
                  PERFORM ABNORMAL-ENDING
           ELSE
                  DISPLAY 'OPCION DE PROCESO ' DATA-PROCESS
      ...
      *    MOVE REG-1R TO WS-PE8062I
           ...
           PERFORM   LEE-ENTRADA-2DA
           MOVE REG-1R TO PE8062I
                          WSSS-PE8062I
      *
           PERFORM VALIDA-EMPRESA-PERSONA.
      *=================================================================

       VALIDA-EMPRESA-PERSONA.
           IF PE8062I-NUMPERSEMP    =    WS-PE8062I-NUMPERSEMP  AND
              PE8062I-NUMPERSACC    =    WS-PE8062I-NUMPERSACC
              EVALUATE   W-DATA-PROCESS
              WHEN 1
                   PERFORM   VALIDA-FECHAS-1
              WHEN 2
                   PERFORM   VALIDA-FECHAS
              WHEN 3
                   PERFORM   VALIDA-SIN-PORCENTAJE
              WHEN OTHER
                   DISPLAY '**************************************'
                   DISPLAY '*OPCION NO RECONOCIDA                *'
                   DISPLAY '*1= VALIDA PORCENTAJE > 25           *'
                   DISPLAY '*2 EN CONSTRUCCION (SUMA PORCENTAJE) *'
                   DISPLAY '*3= NO VALIDA PORCENTAJE, SOLO FECHAS*'
                   DISPLAY '**************************************'
                   PERFORM ABNORMAL-ENDING
           ELSE
              IF W-DATA-PROCESS = 1 OR 2
                 PERFORM  VAL-ULT-REG-EMPRESA-PERSONA
                 MOVE     REG-1R TO WS-PE8062I
                                    WSS-PE8062I
              END-IF
              IF W-DATA-PROCESS = 3
       ...
       VALIDA-FECHAS.
           ADD PE8062I-PORPARTEMP TO WS-PE8062I-PORPARTEMP
           GIVING WS-SUMA

           IF   WS-PE8062I-PORPARTEMP   <=      25
           AND  PE8062I-PORPARTEMP      <=      25
             IF PE8062I-FECALTA  <  WS-PE8062I-FECBAJA AND
                PE8062I-FECALTA  >= WS-PE8062I-FECALTA
                   MOVE   PE8062I-FECALTA  TO   WS-PE8062I-FECALTA
                   MOVE   WS-SUMA          TO   WS-PE8062I-PORPARTEMP
ARANVO*            IF PE8062I-FECBAJA  >  WS-PE8062I-FECALTA AND
ARANVO*               PE8062I-FECBAJA  NOT EQUAL  WS-PE8062I-FECBAJA
ARANVO*               MOVE   PE8062I-FECBAJA  TO   WS-PE8062I-FECBAJA
ARANVO*            END-IF
             ELSE
                MOVE REG-1R TO WS-PE8062I
             END-IF
           ELSE
             IF   PE8062I-PORPARTEMP      >       25
             AND  WS-PE8062I-PORPARTEMP   >       25
               IF PE8062I-FECALTA      >      WS-PE8062I-FECBAJA
                  PERFORM ESCRIBE-SALIDA
                  MOVE REG-1R TO WS-PE8062I
               ELSE
                 IF PE8062I-FECALTA    <=      WS-PE8062I-FECBAJA AND
                    PE8062I-FECBAJA    >       WS-PE8062I-FECALTA
                    MOVE   WS-SUMA     TO      WS-PE8062I-PORPARTEMP
                    IF PE8062I-FECALTA <       WS-PE8062I-FECALTA
                       MOVE   PE8062I-FECALTA  TO   WS-PE8062I-FECALTA
                    END-IF
                    IF PE8062I-FECBAJA >       WS-PE8062I-FECBAJA
       ...
       VALIDA-FECHAS-1.
           ...
           AND  PE8062I-PORPARTEMP      >       25
                ...
                IF PE8062I-FECBAJA  >  WS-PE8062I-FECBAJA
                  MOVE   PE8062I-FECBAJA  TO   WS-PE8062I-FECBAJA
                END-IF
                IF PE8062I-PORPARTEMP       >    WS-PE8062I-PORPARTEMP
                   MOVE PE8062I-PORPARTEMP  TO   WS-PE8062I-PORPARTEMP
                END-IF
           ELSE
           IF   PE8062I-PORPARTEMP   >       25
                MOVE   PE8062I-FECALTA  TO   WS-PE8062I-FECALTA
       ...
       VALIDA-SIN-PORCENTAJE.


      *-- Comprobar solape/continuidad:
      *   Caso 1: el nuevo tramo comienza DESPUÉS de la baja
      *    acumulada + 1 día
      *=> no solapan ni son contiguos: cerramos tramo y empezamos otro
           IF PE8062I-FECALTA > WS-PE8062I-FECBAJA
             PERFORM ESCRIBE-SALIDA
             MOVE REG-1R TO WS-PE8062I
           ELSE
      *-- Caso 2: solapan o son contiguos
      *   Ajustar FECALTA al mínimo
             IF PE8062I-FECALTA < WS-PE8062I-FECALTA
               MOVE PE8062I-FECALTA TO WS-PE8062I-FECALTA
             END-IF

      *   Ajustar FECBAJA al máximo
             IF PE8062I-FECBAJA > WS-PE8062I-FECBAJA
               MOVE PE8062I-FECBAJA TO WS-PE8062I-FECBAJA
             END-IF
           END-IF.
...
SARV  *         IF PE8062I-FECALTA  <  WS-PE8062I-FECALTA
SARV  *           MOVE   PE8062I-FECALTA  TO   WS-PE8062I-FECALTA
SARV  *         END-IF
SARV  *         IF PE8062I-FECBAJA  >  WS-PE8062I-FECBAJA
SARV  *           MOVE   PE8062I-FECBAJA  TO   WS-PE8062I-FECBAJA
SARV  *         END-IF
SARV  *         IF PE8062I-PORPARTEMP       >    WS-PE8062I-PORPARTEMP
SARV  *            MOVE PE8062I-PORPARTEMP  TO   WS-PE8062I-PORPARTEMP
SARV  *         END-IF.

       VAL-ULT-REG-EMPRESA-PERSONA.
           EVALUATE   W-DATA-PROCESS
              WHEN 1
              WHEN 2
                IF   WS-PE8062I-PORPARTEMP   >       25
       ...
       LEE-ENTRADA-2DA.
           ...
           WHEN     '10'
                 MOVE      1           TO WS-FIN-ENTRADA
                 DISPLAY 'FIN DE ARCHIVO ENTRADA 2DA '
                 PERFORM VAL-ULT-REG-EMPRESA-PERSONA
           WHEN  OTHER
                 DISPLAY 'ERROR EN LECTURA 2DA ' FS-PE0001R
                 PERFORM ABNORMAL-ENDING
           END-EVALUATE.
